...
QA_EVAL_SHA256 = "073e5a3c10847f05b9cac6dd9d5dea267794036a028eb755f5de2a883d6ef598"
REVIEWED_RUNTIME_FILES = {
    ...
    EXAMPLES["44"]: (
        144,
        22_021,
        "20d75c2ea63faea7cbccb745842255638406e585435f9eb4030ee3a3145554b4",
    ),
    EXAMPLES["52"]: (
        212,
        28_426,
...
class RuntimeRetrospectiveExamplesTests(unittest.TestCase):
    ...
    def test_public_docs_separate_retrospective_cards_from_source_evals(self) -> None:
        ...
        for wording in (
            ...
            "не устанавливаются пользователю",
            "Девять опубликованных карточек — не такие прогоны",
