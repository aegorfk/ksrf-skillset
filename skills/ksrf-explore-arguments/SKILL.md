...
**Жёсткие пороги, не компенсируемые силой аргумента:**

- надлежащий вид обращения и субъект;
...
- происхождение источника и точность цитаты;
- case-scoped конфиденциальность;
- ручное утверждение перед drafting, filing и export.
...
Если точная норма или её судебное применение ещё не подтверждены, сначала выполни автономный intake по `../ksrf-complaint-cycle/references/ksrf-tool-layer.md`: проанализируй весь пакет, ранжируй нормы по causal role, найди официальный текст и доступные акты по реквизитам дела. Только после исчерпания этих действий верни blocking gap; не проси пользователя самому назвать спорную норму.

## Рабочий цикл

### 1. Собери профиль дела

Используй материалы дела, `CaseFile` и `AutonomousIntakeRecord`. Самостоятельно извлеки наблюдаемое и отдельно пометь исследовательские гипотезы:
