...
Если точная норма или её судебное применение не подтверждены, не имитируй исследование по существу. Верни blocking gap и план получения материала.

## Рабочий цикл

### 1. Собери профиль дела

Используй материалы дела и `CaseFile`, если он доступен. Зафиксируй только наблюдаемое:
