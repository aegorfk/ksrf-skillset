...
- `research/v1/` — отдельная candidate-only проекция; для нового прохода допускается только `hudoc-research-extractive-v5` с совпадающими source/artifact SHA, а записи прежних research versions остаются stale и не участвуют в promotion;
