...
CURATED = [
    ...
    },
    {
        ...
        "full_text_sources": ["Должиков А. В. Соразмерность как общеправовой принцип в конституционном правосудии России"],
        "method_cards": [
            {
    ...
    },
    {
        ...
        "routes": ["evidence_empirics_consequences", "certainty_communication_writing", "comparative_and_international"],
        "full_text_sources": ["Чирнинов А. М. Доказывание и доказательства в конституционном судебном процессе РФ и США"],
        "method_cards": [
            {
    ...
    },
    {
        ...
        "full_text_sources": ["Кряжкова О. Н. Право быть услышанным: меморандумы amici curiae в российском КС РФ"],
        "method_cards": [
            {
                ...
                "skill_reference": "science-support-pack.md; complaint-methodology-sources.md",
            }
        ],
    },
    {
