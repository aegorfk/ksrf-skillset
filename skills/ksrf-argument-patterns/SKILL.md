...
description: Скилл строит и проверяет конституционно-правовые гипотезы, универсальные доводы за и против и узкие формулировки проблемы без исходного исследовательского корпуса. Применяется при анализе текста нового дела, в том числе когда известный исход или яркая аналогия могут подменить первый вопрос; отдельный режим проверяет конкретные судебные позиции. Методика не является закрытой типологией и не определяет готовность жалобы.
---
...
защитить постановку вопроса от известного исхода/яркой аналогии, сравнить
варианты или проследить изменение довода по актам, открой
...
Предмет спора задают текущие материалы. Выбирай операцию по механизму вреда
и необходимым посылкам; отраслевые примеры и состав доступного корпуса не
определяют следующий кейс. Если конституционный механизм не установлен,
сохрани этот вывод с конкретным недостающим звеном.
