...
description: "Навык ищет и проверяет российскую правовую доктрину по любому отраслевому спору, строит карту научных позиций и контрпозиций и проверяет функцию, передачу и фактический эффект экспертных advisory materials. Применяется при исследовании проблемы для жалобы в КС РФ; доктрина не используется как доказательство действующего права, применения нормы или фактов дела."
---
...
Если передан официальный доклад, информационное сообщение или выступление органа, сначала открой [границу между методическим сигналом, судебной ошибкой и дефектом нормы](references/official-reports-and-normative-defects.md). Такой материал помогает построить вопрос и карту исполнения, но не заменяет полный акт, актуальную норму, практику или доказательство индивидуального эффекта.
...
Если для гипотезы существенно, кому, в какой функции и до какой стадии был дан конституционно-правовой совет и что адресат реально сделал с отдельными предложениями, открой [проверку функции, окна и фактического эффекта совета](references/constitutional-advice-function-and-effect.md). Не выводи влияние из формальной обязательности, поздней ссылки или совпадения слов; без российского якоря, применения и вреда результат остаётся `research_only`.
