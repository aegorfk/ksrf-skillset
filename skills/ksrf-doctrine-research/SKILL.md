...
Для разных экспертных объяснений одного взыскания используй [сопоставление заключений по вопросам](references/contested-levy-opinions.md): раздели квалификацию, гарантии, стадии срока и предложения об изменении закона; не приписывай донору или утвердившему лицу авторство всего комплекта.

Подборки о социальных мерах проверяй через [цель поддержки, интерес ребёнка и разногласия ведомств](references/social-support-opinions-and-beneficiary.md): читай мотивировку вместе с выводом, различай подписанта, согласование и авторство, не приписывай Суду более широкое предложение эксперта.
...
Для подборок противоположных ответов используй [конкурирующие заключения, версии и условия личной ответственности](references/adversarial-opinions-and-tax-harm.md): проверяй подписи и существенные расхождения, различай основания ответственности, состав суммы и очередность взыскания; не считай документы голосами за общий вывод.

Для восстановленных пояснений и конкурирующих заключений используй [архивные источники, роли участников и судебный ответ](references/archived-submissions-and-role-transitions.md). Разделяй издателя и Wayback Machine, версии одной работы, заявителя и получателя восстановления; не смешивай отклонение довода с отказом Суда рассматривать вопрос.

Для заключений о личном интересе, доступе к суду или опубликовании норм используй [проверку защищаемого интереса и официальной публикации](references/protected-interest-and-official-publication.md). Раздели авторские версии, суды, события действия нормы и предложения эксперта; донор и адресат не устанавливают авторство.

Для экспертных заключений по неопределённости обязанностей, платежам и переходным правилам используй [разбор институциональных заключений](references/institutional-opinions-and-normative-uncertainty.md). Проверяй собственное производство и расхождения с итогом; поддержка эксперта не доказывает принятие довода Судом.
