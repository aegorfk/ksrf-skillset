...
19. Если результат сопровождается публичной документацией об изученных жалобах или профессиональных донорах, проверь `ComplaintSourceAttribution` по `../ksrf-complaint-cycle/references/source-authority-and-route.md`: активную ссылку на точный источник жалобы, профессиональный канал донора и полный итоговый акт КС РФ. При неполной тройке запрети публичное утверждение об изученном тексте жалобы, сохрани внутренний provenance/status и не подменяй отсутствующую ссылку карточкой, сниппетом либо предположением.
