...
3. Строй факты хронологически, оставляя статус заявителя, попытки реализовать право, непосредственный вред, применение нормы, сохранённые доводы и исчерпание.
4. По каждой судебной стадии фиксируй довод, вывод суда, смысл нормы и точное цитатное окно. Отличай применение от упоминания.
...
11. Направь почти готовый проект в `ksrf-complaint-qa`.
