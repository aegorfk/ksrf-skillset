...
1. Получи `case_id`, `hypothesis_id`, точную норму и редакцию, судебный смысл, механизм вреда, затронутые права, доказательство применения и предполагаемый remedy.
2. Если норма или ее применение не подтверждены, верни blocking gap; не заменяй их похожей практикой.
