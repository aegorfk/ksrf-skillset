...
Прочитай `references/tool-routing.md` перед первым поиском. Начни с доступного официального источника или проверенного полного акта. Если подключён CasusLegal, используй его для расширения поиска и проверки контрпримеров по следующему маршруту:
...
Для иностранных конституционных актов используй [comparative workflow](../constitutional-comparative-research/SKILL.md). Возвращай их как вспомогательный `ResearchFinding` с ролью автора, исходной цитатой, существенным различием и пределом переноса. Российский authority ledger пополняется самостоятельными российскими источниками; проверенный иностранный полный текст не получает роль позиции КС РФ. Полезный приём может сначала породить вопрос по [методике поиска нормативной проблемы](../ksrf-argument-patterns/references/foreign-act-to-constitutional-problem.md), даже если прямая аналогия не найдена.
...
Для арбитражных и корпоративных жалоб используй [разграничение процессуальных механизмов](references/commercial-procedure-boundaries.md): уточни вид срока, редакцию нормы, процедуру исполнения или пересмотра, источник позиции и точный объём результата; сходный спор не заменяет этих проверок.
...
Если применённая норма изменена, отменена, заменена, перенумерована либо изменился её судебный смысл, используй [сопоставление нормативного смысла](../ksrf-complaint-cycle/references/norm-meaning-continuity.md). Ищи официальные акты по прежнему и последующему регулированию, сопоставляй шесть элементов и сохраняй ограничения переноса. Отдельно подтверждай прошлое применение, дальнейшее применение к старым отношениям, сохраняющийся вред и влияние новой редакции; акт по прежней норме не доказывает автоматически ни действие нового регулирования, ни допустимость новой жалобы.

Когда спор зависит от holding/dicta, уровня обобщения, аналогии или решающего оценочного термина, используй поля и stop rules из `../ksrf-argument-patterns/references/legal-reasoning-model-branches.md`. Для термина восстанови официальный origin, definition, factual predicates, scope и operative role; повтор ярлыка нижестоящим судом не доказывает тот же смысл. Common-law термины служат QA-структурой: юридический статус российского акта и применимое положение устанавливай по российской системе источников.
