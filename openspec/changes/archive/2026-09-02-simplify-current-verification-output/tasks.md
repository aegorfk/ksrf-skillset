...
- [x] 3.5 Commit/push, merge/publish exact `main`, install globally, and verify live output.
- [x] 3.6 Archive the OpenSpec change and publish the final manifest-bound commit.
