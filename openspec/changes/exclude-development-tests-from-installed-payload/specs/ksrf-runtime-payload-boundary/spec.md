...
Excluding tests from the installed payload MUST NOT delete source tests, exclude behavioral evals, remove OpenSpec evidence, bypass public-source safety checks, or expand legal, human-review, filing, or publication authority.
...
#### Scenario: Forbidden public artifact is hidden under tests

- **WHEN** a complaint-like or otherwise forbidden source artifact is placed under a source `tests/` directory
