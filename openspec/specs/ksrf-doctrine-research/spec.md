# ksrf-doctrine-research Specification

## Purpose
Define a reproducible, provenance-aware workflow for finding Russian legal doctrine from an applied norm, testing sectoral controversies, and handing only falsifiable candidate constitutional problems to the complaint workflow.
## Requirements
